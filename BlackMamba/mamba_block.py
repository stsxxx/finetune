...
class MambaBlock(nn.Module):
    ...
    def forward(
        ...
        rmsnorm_start = time.time()
        torch.cuda.nvtx.range_push('rms norm')
        ...
        rmsnorm_end = time.time() - rmsnorm_start
        print('rms rnorm time:', rmsnorm_end)
...
class MambaDecoder(nn.Module):
    ...
    def forward(self, hidden_states, residual = None, inference_params=None):
        ...
        for i,layer in enumerate(self.layers):
            ...
            # layer_end = time.time() - layer_start
            # print('layer time:', layer_end)
            
            
        # decoder_end = time.time() -decoder_start
        # print('decoder time:', decoder_end)
        final_layernorm_start = time.time()
        ...
        torch.cuda.nvtx.range_pop()
        torch.cuda.synchronize()
        final_layernorm_end = time.time() - final_layernorm_start
        print('final layernorm time:', final_layernorm_end)
