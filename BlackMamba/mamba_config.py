...
class MambaConfig():
    ...
    def to_json_string(self):
        ...
        # Convert callable attributes to string representations
        for attr_name, attr_value in instance_dict.items():
            if callable(attr_value):
                # Convert the callable attribute to its string representation
                attr_value_str = getattr(attr_value, "__name__", str(attr_value))
                # Update the attribute value in the dictionary
                instance_dict[attr_name] = attr_value_str
