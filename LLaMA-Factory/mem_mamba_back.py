...
def read_log_file(file_path):
    ...
    print('avg w1 backward mem utilization:',avg_w1_util)
    print('avg gelu backward mem utilization:',avg_gelu_util)
    print('avg w2 backward mem utilization:',avg_w2_util)
    print('avg elementwise mem utilization:',avg_element_util)
    print('avg sigmoid backward mem utilization:',avg_sig_util)
    print('avg router_gemm backward mem utilization:', avg_r_gemm_util)
