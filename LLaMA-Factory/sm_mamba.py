...
def read_log_file(file_path):
    ...
    print('avg w1 utilization:',avg_w1_util)
    print('avg gelu utilization:',avg_gelu_util)
    print('avg w2 utilization:',avg_w2_util)
    print('avg elementwise utilization:',avg_element_util)
    print('avg top_k utilization:', avg_topk_util)
    print('avg sig utilization:',avg_sig_util)
    print('avg r_gemm utilization:', avg_r_gemm_util)
