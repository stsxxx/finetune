...
def read_log_file(file_path):
    ...
    print('avg w2 forward mem utilziation:',avg_w2_for_util)
    print('avg w2 dequan mem utilziation:', avg_w2_dequan_util)
    print('avg w3 forward mem utilziation:',avg_w3_for_util)
    print('avg w3 dequan mem utilziation:', avg_w3_dequan_util)
    print('avg silu forward mem utilziation:',avg_silu_for_util)
    print('avg w1 forward mem utilziation:',avg_w1_for_util)
    print('avg w1 dequan mem utilziation:', avg_w1_dequan_util)
    print('avg softmax forward mem utilziation:',avg_soft_for_util)
    print('avg topk mem utilziation:', avg_topk_util)
    print('avg router gemm forward mem utilziation:', router_gemm_for_ut)
    print('avg router dequan mem utilziation:', router_dequan_ut)


    # print('avg softmax forward mem utilziation:',avg_soft_for_util)
    print('avg w2 backward mem utilziation:',avg_w2_back_util)
    print('avg w2 dequan mem utilziation:', avg_w2_dequan_util)
    print('avg w3 backward mem utilziation:',avg_w3_back_util)
    print('avg w3 dequan mem utilziation:', avg_w3_dequan_util)
    print('avg silu backward mem utilziation:',avg_silu_back_util)
    print('avg w1 backward mem utilziation:',avg_w1_back_util)
    print('avg w1 dequan mem utilziation:', avg_w1_dequan_util)
    print('avg softmax backward mem utilziation:',avg_soft_back_util)
    print('avg router gemm backward mem utilziation:', router_gemm_back_ut)
    print('avg router dequan mem utilziation:', router_dequan_ut)
    # print('avg elementwise duration:',avg_elementmult_du)
    # print('avg elementwise mem utilziation:',avg_element_util)
    # print('avg dequant duration:', avg_dquan_du)
    # print('avg dequant mem utilziation:', avg_dquan_util)
